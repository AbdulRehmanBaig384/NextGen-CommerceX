...
//     <h2 className='text-2xl font-semi-bold'>{product.name}</h2>
//     <p className='my-4 xl:w-[35rem] lg:w-[35rem] md:w-[30rem] text-[#808080]'>{product.description}</p>
//     <p className='text-5xl my-4 font-extrabold'>${product.price}</p>

//     <div className="flex items-center justify-between w-[20rem]">
//     <div className='one'>
//     <h1 className='flex items-center mb-6'>
//     <FaStore className='mr-2 text-white'/> Brand:{' '}{product.brand}</h1>
//         <h1 className='flex items-center mb-6'>
//     <FaClock className='mr-2 text-white'/> Added:{' '}{moment(product.createAt).fromNow()}</h1>
//         <h1 className='flex items-center mb-6'>
//     <FaStore className='mr-2 text-white'/> Reviews:{' '}{product.numReviews}</h1>
//         <h1 className='flex items-center mb-6'>
//     <FaStore className='mr-2 text-white'/> Brand:{' '}{product.brand}</h1>
//         <h1 className='flex items-center mb-6'>
//     <FaStore className='mr-2 text-white'/> Brand:{' '}{product.brand}</h1>
