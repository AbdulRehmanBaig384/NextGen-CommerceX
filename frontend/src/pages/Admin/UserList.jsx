...
import { useGetUserDetailsQuery,useDeleteUserMutation,useGetUsersQuery, useUpdateUserMutation } from '../../redux/api/userApiSlice.js'
            ...
            <td className="px-4 py-2">
              {!user.isAdmin && (
                <div className='flex'>
                  ...
                  className='bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded'><FaTrash/></button>
                </div>
              )}
