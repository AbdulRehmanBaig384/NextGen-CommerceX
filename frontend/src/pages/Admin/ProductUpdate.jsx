...
//             }
//             catch(error){
//                 toast.error('Items Added sucessfully')
//             }
//         }
...
//              }else{
//                  toast.success(`Product has been Sucessfully updated`)
...
//                     <img src={image} alt='product' className='block mx-auto mx-auto max-h-[200px]'
// />           </div> )}
//                  <div className='mb-3'>
...
//                                 <input type='text' className='p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white' value={stock} onChange={(e)=>setStock(e.target.value)}></input>
//                             </div>
//                             <div>
//                                 <label htmlFor=''>Category</label><br/>
//                                 <select placeholder='Choose Category' className='p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] 'onChange={(e)=>setCategory(e.target.value)}>
//                                     {categories?.map((e)=>(
